...
internal val Context.highScoreDataStore: DataStore<Preferences> by preferencesDataStore(name = "block_puzzle_prefs")

class HighScoreRepository(context: Context) {

    private val dataStore = context.highScoreDataStore
